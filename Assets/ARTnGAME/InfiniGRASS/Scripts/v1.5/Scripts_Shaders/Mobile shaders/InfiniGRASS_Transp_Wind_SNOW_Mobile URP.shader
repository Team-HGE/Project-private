...
Shader "InfiniGRASS/InfiniGrass Directional Wind SNOW Mobile URP" {
    Properties {
...
////// Lighting:
				...
				UNITY_LIGHT_ATTENUATION(attenuation, i, i.posWorld.xyz); //v1.9 
                 ...
                 float node_133 = pow((abs((frac((i.uv0+node_5027*float2(0.2,0.1)).r)-0.5))*2.0),_BulgeShape);
				   ...
				   float3 attenColor = _LightColorA.xyz;// attenuation * (_LightColorA.xyz);
...
//				}
                ...
                //END SNOW
                float4 col =fixed4(finalColor * _Color  + specular* _SpecularPower * _LightColorA.xyz,1) * 1;//v1.7.7

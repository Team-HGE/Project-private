	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 uv_Textured_Course_AlbedoTransparency = IN.ase_texcoord8.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float scaledFace15 = (ase_vface*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = IN.ase_texcoord4.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				float dotResult3 = dot( (_PlaneClipNormals).xyz , WorldPosition );
				clip( (( _ActivateClip )?( -( dotResult3 + _PlaneClipNormals.w ) ):( 0.0 )) );
...
ASEEND*/
//CHKSM=EE012355CA5F20957206C1554339097A7DF816EC